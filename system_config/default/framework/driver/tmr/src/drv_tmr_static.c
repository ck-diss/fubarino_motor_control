...
{	
    ...
    /*Set period */	
    PLIB_TMR_Period16BitSet(TMR_ID_2, 24000);
...
{	
    ...
    /* Select prescalar value */
    PLIB_TMR_PrescaleSelect(TMR_ID_1, TMR_PRESCALE_VALUE_2);
    /* Enable 16 bit mode */
    PLIB_TMR_Mode16BitEnable(TMR_ID_1);
    /* Clear counter */	
    PLIB_TMR_Counter16BitClear(TMR_ID_1);
    /*Set period */	
    PLIB_TMR_Period16BitSet(TMR_ID_1, 24000);
...
{	
    ...
    /*Set period */	
    PLIB_TMR_Period16BitSet(TMR_ID_3, 15);
...
{	
    ...
    /*Set period */	
    PLIB_TMR_Period16BitSet(TMR_ID_4, 18750);
