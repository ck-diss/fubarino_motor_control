...
// PROXIMITY SENSOR FAULHABER
void __ISR(_EXTERNAL_2_VECTOR, IPL6AUTO) _IntHandlerExternalInterruptInstance0(void)
{    
    ProxFaulhaberInterruptCallback();
    
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_EXTERNAL_2);
}
// PROX_SENSOR MAXON
void __ISR(_EXTERNAL_1_VECTOR, IPL6AUTO) _IntHandlerExternalInterruptInstance1(void)
{     
    ProxMaxonInterruptCallback();
    
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_EXTERNAL_1);
}
// PROG_BUTTON
void __ISR(_EXTERNAL_3_VECTOR, IPL7AUTO) _IntHandlerExternalInterruptInstance2(void)
{   
    PRGButtonInterruptCallback();
    
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_EXTERNAL_3);
}
// PWM Frequency Notwendig für Output Compare
...
void __ISR(_TIMER_1_VECTOR, ipl3AUTO) _IntHandlerDrvTmrInstance1(void)
{
    Timer1msCallback();
...
void __ISR(_TIMER_3_VECTOR, ipl5AUTO) _IntHandlerDrvTmrInstance2(void)
{
    Timer5usCallback();
